...
// Approximates the spec's single per-business "Auto-assign without
// confirmation" toggle by applying it across every mapping for this
// business at once, since the field lives per-mapping in the schema.
export async function PATCH(request: Request) {
  ...
  await CategoryOwnerMapping.updateMany(
    { ownerScope: "business", ownerScopeId: session.business._id },
