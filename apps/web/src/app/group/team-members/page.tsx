  ...
  return (
    <div>
      <div className="page-head">
        <div>
          ...
          <p className="subtitle" style={{ margin: 0 }}>
            Everyone in your Group&rsquo;s own login pool — independent of any branch&rsquo;s team seats.
          </p>
        </div>
      </div>
      ...
      <div className="callout" style={{ marginBottom: 20 }}>
        ...
        Adding, removing, or changing a team member&apos;s access is handled by OodelCX Admin — <a href="/group/support">raise a support ticket →</a>{" "}
