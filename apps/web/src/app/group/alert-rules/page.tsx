...
export default function GroupAlertRulesPage() {
    ...
    <div>
      ...
      <div className="card">
        ...
        {ruleType === "regional_outlier" && (
          <div className="field">
            <label>Sensitivity (std deviations below the group average)</label>
      ...
      {!loading && (
        <>
          ...
          <h3 className="section-label">Individual business rules (oversight)</h3>
          <table className="clean">
            <thead>
              <tr>
                <th>Business</th>
