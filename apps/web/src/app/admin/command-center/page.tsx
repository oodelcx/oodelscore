          ...
          <div className="cc-grid">
            <div className="cc-card">
              <div className="cc-card-head">
                <div className="cc-card-title">Client Health · 30d</div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="cc-branch-region">
                        {t.kind.toUpperCase()}
                        {signal && (signal.signal === "at_risk" ? " · AT RISK" : " · EXPANSION READY")}
                      </div>
              ...
              <div className="cc-card-head" style={{ marginTop: 16 }}>
                <div className="cc-card-title">CX Pulse Maturity · Portfolio</div>
            ...
            <div className="cc-card">
              <div className="cc-card-head">
                <div className="cc-card-title">Live Platform Feed</div>
            ...
            <div>
              <div className="cc-card" style={{ marginBottom: 12 }}>
                <div className="cc-card-head">
                  <div className="cc-card-title">CX Pulse · Platform</div>
                </div>
