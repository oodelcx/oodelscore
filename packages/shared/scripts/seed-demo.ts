...
import { ParentOrganization } from "../src/models/ParentOrganization";
import { Business } from "../src/models/Business";
import { hashPassword } from "../src/auth/password";
import type { AccountType } from "../src/models/User";
 ...
 * skipping the invite email, since the point is working credentials to
 * hand back, not exercising Resend delivery.
 *
 * Idempotent — safe to re-run. Never run this against a production database.
 */
